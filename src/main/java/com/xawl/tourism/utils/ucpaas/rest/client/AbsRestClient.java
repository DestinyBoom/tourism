 ...
 * @project rest_demo
 */
package com.xawl.tourism.utils.ucpaas.rest.client;

import java.io.ByteArrayInputStream;

import com.xawl.tourism.utils.ucpaas.rest.EncryptUtil;
import com.xawl.tourism.utils.ucpaas.rest.SSLHttpClient;
import com.xawl.tourism.utils.ucpaas.rest.SysConfig;
...
public abstract class AbsRestClient {
	 ...
	 *            注册云之讯官网，在控制台中即可获取此参数
	 * @param appId
	 *            创建应用时系统分配的唯一标示，在“应用列表”中可以查询
	 * @param templateId
	 *            创建短信模板时系统分配的唯一标示，在“短信管理”中可以查询
	 * @param to
	 *            需要下发短信的手机号码,支持国际号码，需要加国家码
	 * @param param
	 *            需要下发短信的手机号码,支持国际号码，需要加国家码
