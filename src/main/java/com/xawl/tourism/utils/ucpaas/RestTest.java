...
import com.xawl.tourism.utils.ucpaas.rest.client.AbsRestClient;
import com.xawl.tourism.utils.ucpaas.rest.client.JsonReqClient;
import com.xawl.tourism.utils.ucpaas.rest.client.XmlReqClient;
...
public class RestTest {
	...
	static AbsRestClient InstantiationRestAPI(boolean enable) {
		if(enable) return new JsonReqClient();
		else {
